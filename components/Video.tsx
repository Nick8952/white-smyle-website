...
export function Video({ youtubeId, titel, texte: t }: { youtubeId: string; titel: string; texte: Texte["einwilligung"] }) {
  ...
  return (
    <figure className="grid gap-3">
      ...
      <div
        className={`relative rounded-[var(--radius-gross)] border border-linie bg-tinte ${zeigen ? "overflow-hidden" : "grid"}`}
      ...
      >
        {zeigen ? (
          ...
          <>
            ...
            <div className="col-start-1 row-start-1 grid place-items-center p-6 text-center text-papier">
